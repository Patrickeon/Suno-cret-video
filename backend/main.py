...
async def create_render(
    ...
    disc_lp_side: str = Form("right"),
    disc_ring_side: str = Form("left"),
    progress_bar: bool = Form(False),
    progress_bar_pos: str = Form("bottom"),
    progress_bar_color: str = Form(""),
    title_caption: bool = Form(False),
    title_caption_pos: str = Form("auto"),
    ...
    opts = {
        ...
        "disc_lp_side": disc_lp_side,
        "disc_ring_side": disc_ring_side,
        ...
        "title_caption_pos": title_caption_pos,
